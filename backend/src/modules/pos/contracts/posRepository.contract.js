const REQUIRED_METHODS = [
    ...
    'getVerifiedFiscalTerminalRegistration',
    'upsertFiscalTerminalRegistration',
    'listFiscalTerminalRegistrations',
    'getLatestFiscalEvent',
    'listFiscalEvents',
    'createFiscalEvent',
    'countFiscalPrintEvents',
    'createFiscalPrintEvent',
    'updateTransactionLifecycle',
    'listStockMovementsForPosTransaction',
    'listFiscalTransactionsForMonth',
    'upsertESalesReport',
    'listESalesReports',
    'findESalesReportById',
