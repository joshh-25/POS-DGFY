...
const migrationPath = path.resolve(
  process.cwd(),
  'migrations/20260729000001-create-employee-credit-ledger.cjs'
);
const migrationContent = fs.readFileSync(migrationPath, 'utf8');
const employeeDirectoryMigrationPath = path.resolve(
  process.cwd(),
  'migrations/20260729000002-create-employee-directory.cjs'
);
...
const outstandingBalanceMigrationPath = path.resolve(
  process.cwd(),
  'migrations/20260730000001-convert-employee-credit-to-outstanding-balance.cjs'
);
