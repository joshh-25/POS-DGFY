...
const migrationPath = path.resolve(
  __dirname,
  '../../dgfy-migration-runner/migrations/20260730000002-create-tenant-revenue-settlement.cjs'
);
const content = fs.readFileSync(migrationPath, 'utf8');
const fulfillmentGateMigration = fs.readFileSync(path.resolve(
  __dirname,
  '../../dgfy-migration-runner/migrations/20260731000001-gate-tenant-revenue-by-fulfillment.cjs'
), 'utf8');
