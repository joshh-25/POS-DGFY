...
describe('POS cashier attendance lifecycle route contract', () => {
    it('exposes every lifecycle action with dedicated attendance permissions', () => {
        ...
        expect(routeSource).toContain("router.post('/terminal/operator/resume', checkPermission(PERMISSIONS.POS.actions.OPERATE_ATTENDANCE), posController.requirePairedTerminal, validateCashierResume, posController.resumeCashier);");
    });
