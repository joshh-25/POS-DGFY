...
describe('POS split-payment route contract', () => {
    it('exposes scoped session, allocation, and cancellation endpoints', () => {
        expect(routeSource).toContain("router.post('/payment-sessions', checkPermission(PERMISSIONS.POS.actions.TRANSACT_POS), posController.requirePairedTerminal, validateCreatePosPaymentSession, posController.requireActiveOperatorForMutation, posController.createPaymentSession);");
        ...
        expect(routeSource).toContain("router.post('/payment-sessions/:id/allocations', checkPermission(PERMISSIONS.POS.actions.TRANSACT_POS), posController.requirePairedTerminal, validateSplitPaymentSessionIdParam, validateAddPosPaymentAllocation, posController.requireActiveOperatorForMutation, posController.addPaymentAllocation);");
        ...
        expect(routeSource).toContain("router.post('/payment-sessions/:id/cancel', checkPermission(PERMISSIONS.POS.actions.TRANSACT_POS), posController.requirePairedTerminal, validateSplitPaymentSessionIdParam, validateCancelPosPayment, posController.requireActiveOperatorForMutation, posController.cancelPaymentSession);");
        expect(routeSource).toContain("router.post('/payment-sessions/:id/complete', checkPermission(PERMISSIONS.POS.actions.TRANSACT_POS), posController.requirePairedTerminal, validateSplitPaymentSessionIdParam, validateCompletePosPayment, posController.requireActiveOperatorForMutation, posController.completePaymentSession);");
    });
