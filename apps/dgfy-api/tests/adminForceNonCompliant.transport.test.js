...
jest.unstable_mockModule('../src/controllers/adminTenantController.js', () => ({
    ...
    applyTemplateToTenant: noopHandler,
    ...
    getTenantAffiliateSlots: noopHandler,
    listTenantAffiliateSlotsAuditLogs: noopHandler,
    updateTenantAffiliateSlots: noopHandler,
