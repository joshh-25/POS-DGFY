 ...
 * direct GCash use the landlord collection model and therefore do not require
 * a tenant Linked Account or a split recipient. QR Ph retains the legacy
 * split-account requirements through requireCommerceQrphConfig().
 */
export const requireCommercePaymentConfig = ({
  ...
  if (requiresDirectGcash && !modeSpecificPublicKey && !process.env.PAYMONGO_PUBLIC_KEY) {
