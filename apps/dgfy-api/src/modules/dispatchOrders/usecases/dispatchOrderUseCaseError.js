...
export const mapDispatchOrderUseCaseError = (error, fallbackMessage = 'Dispatch order operation failed') => {
  ...
  const hasNotFoundMessage = typeof message === 'string' && message.toLowerCase().includes('not found');
