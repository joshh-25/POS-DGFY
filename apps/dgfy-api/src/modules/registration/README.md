...
`apps/dgfy-api/src/models/Landlord/RegistrationIndustry.js`) is the runtime
...
(`apps/dgfy-api/src/routes/adminRegistrationIndustries.js`).
...
- Adding a new industry is now an **admin action** through the
  ...
  constant edit. `apps/dgfy-api/tests/registrationIndustries.contract.test.js`
