...
// Mirrors backend/src/modules/shared/controllers/useCaseResponder.js's
// response envelope so mobile clients get a response shape consistent with
// the existing backend contract.
export const resolveDomainFailure = (result, fallbackStatusCode = 500, fallbackMessage = 'Internal Server Error') => {
