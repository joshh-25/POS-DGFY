 ...
 * still called this with only `reportedMime` at that point. Phase 297 (#265) is the wiring: metadata
 ...
 * storeOptimizedImageAsset as of Phase 297 (#265): called for the primary delivery format's
...
export const storeOptimizedImageAsset = async ({
    ...
    tempPath,
    retainOriginal = true,
    // -- Phase 297 (#265) additions, all optional and all inert unless a caller explicitly opts
    ...
    try {
        // Reordered as of Phase 297 (#265): the rename + metadata() fetch now happen BEFORE
        ...
        // -- Accepted-large resolution (Phase 297, #265): if the caller flags the just-renamed
        ...
        const manifest = {
            ...
            original: {
                ...
                // Additive (Phase 297, #265): the pre-conversion MIME hint the client's manifest
            ...
            // Additive (Phase 297, #265): per-variant provenance for the PRIMARY delivery format
        ...
        return {
            ...
            classification,
            // Additive (Phase 297, #265): see the matching comment on `manifest.provenance` above.
            provenance,
