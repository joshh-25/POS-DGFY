...
describe('Food & Beverage frontend contract', () => {
  ...
  it('attaches F&B check context to POS checkout and receipts', () => {
    ...
    const checkoutWorkflow = read('apps/dgfy-web/src/features/pos/hooks/usePosCheckoutWorkflow.js');
    const cartWorkflow = read('apps/dgfy-web/src/features/pos/hooks/usePosCartWorkflow.js');
    const modifierUtils = read('apps/dgfy-web/src/features/pos/utils/posCheckoutTerminalModifiers.js');
