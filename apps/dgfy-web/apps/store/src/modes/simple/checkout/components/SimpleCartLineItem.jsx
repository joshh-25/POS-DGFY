...
/**
 * Layout matches F&B's inline cart line item (FnbCartDrawerContent.jsx) and Retail's
 * DefaultProductCartLineItem.jsx — divider-separated rows, quantity badge on the thumbnail,
 * unified pill quantity stepper — using this mode's own teal brand color for the badge.
 */
