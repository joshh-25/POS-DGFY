/**
 * Presentation-only shell for the expanded retail delivery map. Mirrors
 * modes/simple/checkout/components/SimpleCheckoutExpandedMapModal.jsx (generic, no
 * brand-specific styling) — kept as its own file per the "independent trees" pattern.
 */
export function RetailOrderExpandedMapModal({
  bodyFont,
  children,
  displayFont,
  isMobileViewport,
