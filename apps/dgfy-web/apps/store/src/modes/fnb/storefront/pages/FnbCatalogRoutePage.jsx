...
export function FnbCatalogRoutePage({ addToCart, catalogError, catalogItems, catalogSearch, catalogState, checkoutVoucherCode, setCheckoutVoucherCode, handleVoucherCardApply, filteredCatalog, filteredCatalogViewModel, getCartFlySourceRect, hasCatalogSearchQuery, isCategoryDropdownOpen, isCompactPaginationViewport, isDesktopViewport, isMobileViewport, isTabletPaginationViewport, modeAdapter, mobileCatalogPadding, mobileContentWidth, onCategoryChange, onCategoryDropdownOpenChange, onPageChange, onPageSizeChange, onSearchChange, onSortChange, onViewDetails, onViewModeChange, page, pageEnd, pageSize, pageStart, refreshStorePageForTenantSetup, resolvedSection, sortOption, totalItems, totalPages, viewMode, categoryDropdownRef }) {
