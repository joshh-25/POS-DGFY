export function formatFnbTrackingDrawerDate(value) {
...
export function resolveFnbTrackingDrawerStatus(rawStatus) {
...
export function deriveFnbTrackingDrawerItems(entry = {}) {
...
export function deriveFnbTrackingDrawerTotals(entry = {}, money) {
