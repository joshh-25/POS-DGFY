...
import { buildBusinessRegistrationUrl } from '../../shared/utils/businessRegistrationUrl.js';
import { DiscoveryFooter } from '../components/DiscoveryFooter.jsx';
...
export function SolutionsPage({ logoSrc, onExploreClick, isMobileViewport }) {
  ...
  return (
    <div style={{
      ...
      {/* ── 5. FOOTER ── */}
      <DiscoveryFooter
        anchorId="solutions-contact-anchor"
        dgfyHeaderLogo={logoSrc}
