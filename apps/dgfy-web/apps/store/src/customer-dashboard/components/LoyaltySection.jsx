...
export function LoyaltySection({ loyalty, transactions, EmptyState, formatDate, prettyStatus, theme }) {
  return (
    <div style={{ display: 'grid', gap: 24 }}>
      ...
      <div style={{ background: theme.surface, borderRadius: 16, border: `1px solid ${theme.border}`, padding: 32, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 24 }}>
        ...
        <div style={{ border: `1px solid ${theme.border}`, borderRadius: 10, padding: '10px 16px', color: theme.muted, fontSize: 13, fontWeight: 700 }}>Rewards redemption is currently in development.</div>
      </div>
