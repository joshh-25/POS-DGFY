...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        const { resolveShiftLocationCandidate, shiftLocationResolution } = await import('../src/modules/pos/utils/shiftLocationResolution.js');
        const lowConfidenceSources = shiftLocationResolution?.LOW_CONFIDENCE_RESOLUTION_SOURCES || new Set();
