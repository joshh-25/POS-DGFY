...
/**
 * FeedbackDashboard - child component for AdminLayout
 * Displays user feedback (bugs & suggestions)
 */
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-slate-500 text-sm mt-1">User submitted bugs and suggestions</p>
                    </div>
                    <Button onClick={loadFeedback} variant="outline" disabled={loading}>
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex flex-wrap gap-4 text-sm">
                                            ...
                                            {(item.user || item.user_id) && (
                                                <div className="flex flex-wrap gap-x-4 gap-y-1 items-center text-slate-600 bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-100">
