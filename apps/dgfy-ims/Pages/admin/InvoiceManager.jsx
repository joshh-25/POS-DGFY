...
// Chrome 80-84 iMin/legacy WebView has no Array.prototype.at (ES2022 / Chrome 92+). See #666.
const lastDeliveryStatus = (deliveries) => (deliveries?.length ? deliveries[deliveries.length - 1]?.status : 'Not sent');
