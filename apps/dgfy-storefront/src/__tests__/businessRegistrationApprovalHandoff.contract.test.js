...
describe('storefront business registration approval handoff', () => {
  it('routes a submitted application to the approval status page instead of POS', () => {
    ...
    expect(source).toContain('resolveSkupervisorUrl(`/register-company/status/${registrationData.application_id}`)');
