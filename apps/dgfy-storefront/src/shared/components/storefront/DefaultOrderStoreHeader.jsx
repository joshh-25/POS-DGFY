/**
 * Default/Retail order page's store header bar. Mirrors
 * modes/simple/checkout/components/SimpleCheckoutStoreHeader.jsx's layout, kept as its own
 * file per the "independent trees" pattern.
 */
export function DefaultOrderStoreHeader({
