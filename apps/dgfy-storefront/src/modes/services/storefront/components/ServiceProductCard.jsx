      ...
      <div style={{ padding: 16, flex: 1, display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <div style={{ marginTop: 'auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
            ...
            <PrimaryButton accentColor={servicesPrimary} accentDarkColor={servicesPrimaryDark} shadowColor="rgba(26,78,141,0.24)" style={{ padding: '8px', minHeight: 40, fontSize: 13 }} onClick={(e) => { e.stopPropagation(); addToCart(item, { sourceRect: getCartFlySourceRect(e) }); }} disabled={!available}>Add</PrimaryButton>
          </div>
        </div>
      </div>
    </div>
