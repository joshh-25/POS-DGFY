export function formatRetailTrackingDrawerDate(value) {
...
export function resolveRetailTrackingDrawerStatus(rawStatus) {
...
export function deriveRetailTrackingDrawerTotals(entry = {}, money) {
