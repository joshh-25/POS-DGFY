...
export function toSimpleTrackingViewState(trackingPayload) {
  ...
  return {
    ...
    specialInstructions: String(normalized.specialInstructions || order?.special_instructions || root?.special_instructions || raw?.special_instructions || orderDisplay?.special_instructions || payloadDisplay?.special_instructions || '').trim(),
