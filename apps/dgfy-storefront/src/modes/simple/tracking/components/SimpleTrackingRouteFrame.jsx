...
/** Simple/MSME tracking route chrome. */
export function SimpleTrackingRouteFrame({
  children,
  displayFont,
  goStoreCatalogPage,
  isMobileViewport,
  ...
  return (
    <div style={{ width: '100vw', minHeight: '100vh', marginLeft: 'calc(50% - 50vw)', background: '#fff' }}>
      <div
        style={{
          maxWidth: 1240,
          margin: '0 auto',
        ...
        >
          <div style={{ width: 40, height: 40, borderRadius: '50%', border: '1px solid #dbe5ee', overflow: 'hidden', background: '#f8fafc', display: 'grid', placeItems: 'center', flexShrink: 0 }}>
            {profileImageUrl ? (
              ...
              <span style={{ fontSize: 11, fontWeight: 700, color: '#64748b' }}>Logo</span>
            )}
          </div>
          <div style={{ minWidth: 0, display: 'grid', gap: 2 }}>
            ...
            <div style={{ fontSize: 20, fontWeight: 700, color: '#1e293b', lineHeight: 1.2, fontFamily: displayFont, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
              {storeName}
            </div>
          </div>
        </a>
