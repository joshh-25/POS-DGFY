/**
 * Presentation-only shell for the expanded MSME delivery map. Mirrors
 * FnbCheckoutExpandedMapModal.jsx (generic, no brand-specific styling) — kept as
 * MSME's own file per the "two independent checkout trees" decision.
 */
export function SimpleCheckoutExpandedMapModal({
  bodyFont,
  children,
  displayFont,
  isMobileViewport,
