...
4. Treat the June 6 Storefront public visibility opt-in as locally validated but production-pending until the public-visibility audit is run against production tenant data and hidden/visible tenant discovery/profile smoke is captured.
