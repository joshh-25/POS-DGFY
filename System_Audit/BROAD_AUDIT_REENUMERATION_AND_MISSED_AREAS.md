...
- Release evidence drift: stale or bypassable QA deployed-head evidence paths. The local release gate now has a current passing artifact for SHA `be59a6b55f4d6367acd124729b43fa4ee579d09b`, including backend matrix and release-owned frontend budget evidence, but production SHA and deployed asset parity remain separate evidence requirements.
