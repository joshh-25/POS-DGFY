...
- Targeted frontend suites passed from `frontend/`: `npm exec vitest run src/components/maps/__tests__/MapPinPicker.maplibre.test.jsx src/features/onboarding/__tests__/OnboardingSetupModal.behavior.test.jsx src/pages/__tests__/Settings.deepLinking.integration.test.jsx --pool=threads` (58 tests).
