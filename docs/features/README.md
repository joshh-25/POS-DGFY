...
- Current storefront implementation standing for shared template registry, mode-specific presentation, duplicate-coordinate marker fanout, MapLibre/WebGL fallback behavior, and current storefront regression/build evidence.
