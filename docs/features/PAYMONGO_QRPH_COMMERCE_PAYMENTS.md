...
- Admin > Payments remains an operator panel, not automated PayMongo child-merchant onboarding. Active readiness must only be set from PayMongo-verified merchant capability evidence until hosted/API onboarding is implemented.
