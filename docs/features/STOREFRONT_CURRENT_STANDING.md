...
- Storefront discovery search uses the PR #18 relevance closeout: Fuse.js ranking, exact/token fallback ordering, and map-pin fallback for search results without usable coordinates are production-live in SHA `9c03af78bfe2847031cfa383896b9b92e08ef6f7`.
- The routed DGFY customer dashboard uses the updated overview/orders/business layout and is production-live in SHA `9c03af78bfe2847031cfa383896b9b92e08ef6f7`; dashboard/order surfaces must retain tracking actions and business registration while avoiding customer-visible `company_token`.
