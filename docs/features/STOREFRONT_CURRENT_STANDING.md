...
- June 10 runtime standing: latest production evidence available in this workspace records deployed code SHA `9e7c64ceaaa6e0f636db0cf59e413874b03f7b70`; at proof time remote `HEAD`, remote `origin/master`, and `.deploy-state/last_deployed_commit` matched that SHA. The Storefront gallery preservation work from `5e327ba74fd83aa457339233536232efdd8fa8d0` is included in that later production runtime evidence.
