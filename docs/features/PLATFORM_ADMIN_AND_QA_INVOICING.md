...
Do not use this UI as a live VAT invoice, input-tax document, POS receipt, merchant settlement record, subscription payment, or inventory event. Live mode is intentionally fail-closed under ADR 0040.
