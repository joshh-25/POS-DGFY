...
3. Selected PayPal payment webhook outcomes
...
3. Route-level persistence of telemetry rows for those flows
4. Server-side usage of selected core product workflows beyond billing/admin onboarding
5. Correlation, request, surface, and source fields when callers or middleware provide them
6. Idempotent suppression for some retried requests when the correlation identity is stable
