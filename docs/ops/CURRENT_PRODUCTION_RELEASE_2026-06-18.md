...
- Local `master`: `4cf4c372c9eae91c6ead5932e19476f4c1b98e83`
- Local `origin/master`: `4cf4c372c9eae91c6ead5932e19476f4c1b98e83`
- Latest deploy summary evidence: `.tmp/release-gates/4cf4c372c9eae91c6ead5932e19476f4c1b98e83/qa_deploy_summary.txt`
- Production deploy summary path recorded by the fetched evidence: `/var/www/skupervisor/logs/deploy/deploy_20260618_114003.summary.txt`
- Deploy summary `deployed_head`, `remote_head`, and `expected_commit`: `4cf4c372c9eae91c6ead5932e19476f4c1b98e83`
- Live production `/api/v1/health` reports `services.observability.runtime_sha=4cf4c372c9eae91c6ead5932e19476f4c1b98e83` with source `deploy_state:last_deployed_commit`.
...
- Artifact: `.tmp/release-gates/4cf4c372c9eae91c6ead5932e19476f4c1b98e83/release_verdict.json`
- Verdict: `pass`
- Failed gates: `0`
...
- Artifact: `.tmp/release-gates/4cf4c372c9eae91c6ead5932e19476f4c1b98e83/observability_evidence.json`
...
The current production runtime includes the branch and PR adoption chain from the earlier proven production SHA through `4cf4c372`:
...
- PR #20 POS and DGFY Storefront closeout: POS safety and DGFY Storefront customer-flow updates are in `master` and included in the deployed `4cf4c372` runtime chain.
