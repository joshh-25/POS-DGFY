...
2. `docs/ops/RELEASE_CANDIDATE_POLICY.md` (`docs/ops/NO_STAGING_RELEASE_STANDARD.md` is superseded by it)
...
`docs/ops/RELEASE_CANDIDATE_POLICY.md` for the actual `develop -> release/*
-> main` flow (an optional `staging` soak is still available per batch, not
the default as of 2026-08-25, ADR 0074) and what gates it. `docs/ops/
