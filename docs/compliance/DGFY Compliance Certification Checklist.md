...
5. Regression evidence expanded to include:
   - `packages/web-core/src/features/settings/__tests__/settingsDeepLink.contract.test.js`
   - `packages/web-core/src/pages/__tests__/Settings.deepLinking.integration.test.jsx`
   - `packages/web-core/src/features/compliance/__tests__/ComplianceProgramPanel.integration.test.jsx`
...
- [x] Tamper-Proofing (No Bypass Modes)
  ...
  - References: `apps/dgfy-api/src/modules/compliance/policy/compliancePolicyEngine.js`, `apps/dgfy-api/src/modules/pos/usecases/posUseCases.js`, `packages/web-core/src/features/pos/components/ReceiptPrintView.jsx`, `apps/dgfy-api/tests/compliancePolicyEngine.test.js`.
...
- [x] Non-Volatile Persistence
  ...
  - References: `packages/web-core/src/features/pos/components/POSCheckoutTerminal.jsx`, `packages/web-core/src/features/pos/pages/TerminalPage.jsx`, `apps/dgfy-api/src/modules/pos/usecases/posUseCases.js`, `apps/dgfy-api/src/models/PosOperationReplay.js`, `apps/dgfy-api/tests/posOperationReplayParity.usecase.test.js`.
...
- [x] VAT / Non-VAT Segregation
  ...
  - References: `apps/dgfy-api/src/modules/pos/usecases/posUseCases.js`, `packages/web-core/src/features/pos/components/ReceiptPrintView.jsx`, `apps/dgfy-api/tests/posSalesReconciliation.db.integration.test.js`, `packages/web-core/src/features/pos/__tests__/receiptContractConformance.contract.test.js`.
...
- [x] Standardized Receipt/Invoice Format
  ...
  - References: `apps/dgfy-api/src/modules/pos/usecases/posUseCases.js`, `packages/web-core/src/features/pos/components/ReceiptPrintView.jsx`, `packages/web-core/src/features/pos/__tests__/receiptContractConformance.contract.test.js`, `docs/api/specification.md`.
...
- [x] External Payment Handoff
  ...
  - References: `apps/dgfy-api/src/modules/compliance/policy/compliancePolicyEngine.js`, `apps/dgfy-api/src/middleware/compliancePolicy.js`, `packages/web-core/src/features/pos/pages/TerminalPage.jsx`, `packages/web-core/src/features/pos/components/TerminalPageLayout.jsx`, `packages/web-core/src/features/settings/settingsDeepLink.js`, `packages/web-core/src/features/settings/__tests__/settingsDeepLink.contract.test.js`, `packages/web-core/src/pages/__tests__/Settings.deepLinking.integration.test.jsx`, `packages/web-core/src/features/compliance/__tests__/ComplianceProgramPanel.integration.test.jsx`, `apps/dgfy-api/tests/compliancePolicyEngine.test.js`.
