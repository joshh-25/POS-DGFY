...
As of 2026-08-06 this branch also relocated the frontend tree (ADR 0055), so `backend/` and
...
compose service, and nginx upstream all deliberately kept their names, per ADR 0055), the compliance
