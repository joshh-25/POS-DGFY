...
Update note (2026-05-21): ADR 0023 amends public company registration. New public registrations no longer choose compliance mode during registration; they always start `non_compliant_active`. Compliance activation remains available after login through Settings > Compliance.
