 ...
 *
 * Mirrors imin-wrapper's ReceiptLogoProvider.kt -- see TtlLruCache.kt in this same
 * package for why this is duplicated rather than shared.
 */
class ReceiptLogoProvider(
    ...
    companion object {
        ...
        // Default fetcher: http(s) URL or a data: URI. Any other scheme (e.g. a
        // page-scoped blob: URL) returns null and falls back to the bundled drawable.
