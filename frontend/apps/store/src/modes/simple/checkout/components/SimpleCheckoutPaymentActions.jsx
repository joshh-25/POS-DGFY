...
export function SimpleCheckoutPaymentActions({
  ...
  return (
    <>
      ...
      <button type="button" onClick={onBack} style={{ justifySelf: 'start', minHeight: isMobileViewport ? 40 : 42, borderRadius: 12, border: '1px solid #cbd5e1', background: '#fff', color: '#334155', padding: '0 16px', fontWeight: 700, cursor: 'pointer', fontSize: actionFontSize, display: 'inline-flex', alignItems: 'center', gap: 6 }}>
