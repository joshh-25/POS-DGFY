        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 20, padding: 20 }}>
            ...
            <div style={{ display: 'grid', gap: 12 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ display: 'inline-flex', gap: 10, alignItems: 'center' }}><MessageSquare size={20} />Chat with support</span><span>{'>'}</span></div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ display: 'inline-flex', gap: 10, alignItems: 'center' }}><HelpCircle size={20} />View help center</span><span>{'>'}</span></div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
            <button type="button" onClick={onBackToMenu} style={{ minWidth: 160, padding: '14px 24px', borderRadius: 14, border: '1px solid #cbd5e1', background: '#fff', color: '#0f172a', fontWeight: 800, fontSize: 15, cursor: 'pointer' }}>Back to Menu</button>
            <button type="button" style={{ minWidth: 160, padding: '14px 24px', borderRadius: 14, border: 'none', background: '#1a4e8d', color: '#fff', fontWeight: 800, fontSize: 15, cursor: 'pointer' }}>{currentIndex >= 4 ? 'Order Again' : 'Need Help?'}</button>
          </div>
        </div>
      </div>
    </div>
