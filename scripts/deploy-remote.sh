...
if hostname -I 2>/dev/null | tr ' ' '\n' | grep -Fxq "$REMOTE_HOST"; then
    ...
    export DEPLOY_TENANT_INDEX_HEADROOM_STRICT="$DEPLOY_TENANT_INDEX_HEADROOM_STRICT"
...
REMOTE_EXPORTS="${REMOTE_EXPORTS}; export DEPLOY_TENANT_INDEX_HEADROOM_STRICT='${DEPLOY_TENANT_INDEX_HEADROOM_STRICT}'"
