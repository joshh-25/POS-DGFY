...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/.gsd-surface.json`
(sibling to `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/pat/Projects/Sieitz/dgfy-platform/.claude/skills`).
...
`/Users/pat/Projects/Sieitz/dgfy-platform/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/.gsd-surface.json`
Install profile marker: `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/.gsd-profile`
Skill dirs: `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/skills/gsd-*/`
Engine module: `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
