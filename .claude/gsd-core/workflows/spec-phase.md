...
ones). Reference: @/Users/pat/Projects/Sieitz/dgfy-platform/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/pat/Projects/Sieitz/dgfy-platform/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/pat/Projects/Sieitz/dgfy-platform/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/pat/Projects/Sieitz/dgfy-platform/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/pat/Projects/Sieitz/dgfy-platform/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/pat/Projects/Sieitz/dgfy-platform/.claude/gsd-core/templates/spec.md.
