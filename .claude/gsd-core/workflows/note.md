...
- **Global scope**: `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/notes/`)
...
2. Glob `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/pat/Projects/Sieitz/dgfy-platform/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/notes/` — works in any directory
