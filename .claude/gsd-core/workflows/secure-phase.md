...
```
Agent(
  prompt="Read /Users/pat/Projects/Sieitz/dgfy-platform/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/gsd-core/templates/SECURITY.md`
