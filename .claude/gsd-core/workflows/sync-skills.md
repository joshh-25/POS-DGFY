...
INSTALL_JS_GLOBAL="/Users/pat/Projects/Sieitz/dgfy-platform/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/pat/Projects/Sieitz/dgfy-platform/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
