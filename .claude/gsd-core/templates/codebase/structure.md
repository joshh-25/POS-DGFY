...
- Usage: Reference from command with `@/Users/pat/Projects/Sieitz/dgfy-platform/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/pat/Projects/Sieitz/dgfy-platform/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/pat/Projects/Sieitz/dgfy-platform/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
