...
<reference>
@/Users/pat/Projects/Sieitz/dgfy-platform/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/pat/Projects/Sieitz/dgfy-platform/.claude/gsd-core/references/user-profiling.md` to load:
