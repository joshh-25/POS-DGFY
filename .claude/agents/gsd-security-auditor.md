...
**Verification depth scales with `asvs_level`** (see @/Users/pat/Projects/Sieitz/dgfy-platform/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
