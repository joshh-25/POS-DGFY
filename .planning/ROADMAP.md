...
- [ ] 08-01-PLAN.md — Commerce-foundation migration (8 tenant tables + append-only triggers + one-open-shift generated-column unique index) + schema-contract update so verify passes (PRD-04, PRD-05, SFT-01, SFT-03)

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 08-02-PLAN.md — 8 Tenant Sequelize models (insert-only ledgers) + TenantConnector modelDefiners registry (PRD-01, PRD-02, PRD-04, SFT-01, SFT-02, FSC-01)

**Wave 3** *(blocked on Wave 2 completion; 4 parallel module plans)*

- [ ] 08-03-PLAN.md — products module: Product CRUD (Food/Service/Retail, inventory_mode), flat folders, mark-bookable config (PRD-01, PRD-02, PRD-03, PRD-05, BOK-01)
- [ ] 08-04-PLAN.md — inventory module: sole-writer append-only ledger (restock/loss/adjustment) + reserved sale/booking effect contracts (PRD-04)
...
- [ ] 08-07-PLAN.md — booking module: create/cancel with atomic branch-capacity guard, dual-auth cancel, reserved availment link (BOK-02, BOK-03)

**Wave 5** *(blocked on all module plans)*

- [ ] 08-08-PLAN.md — composition-root wiring: build + mount all 5 commerce modules, cross-module injection, mount/integration smoke test (PRD-01, PRD-03, BOK-02, SFT-01, FSC-02)
...
| 8. Commerce Foundation — Product Catalog, Booking, Shift & Cash Drawer, Compliance Gating | 0/8 | Not started | - |
