...
import LegalDocument from '../../../../../../apps/dgfy-ims/Pages/LegalDocument.jsx';
import {
...
// apps/dgfy-ims when the shared trunk moved into packages/web-core -- see
// docs/architecture/frontend-split-sync.md.
const frontendRoot = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '../../../../../../apps/dgfy-ims');
