...
describe('POS terminal responsive scroll contracts', () => {
  ...
  it('keeps responsive catalog cards and paginated catalog slices', () => {
    ...
    expect(posCheckoutContent).toContain('className="grid w-full min-w-0 items-center gap-x-3 gap-y-2 max-sm:gap-y-1 sm:grid-cols-[minmax(0,auto)_minmax(0,1fr)_auto_auto] max-sm:grid-cols-[minmax(0,1fr)_auto]"');
