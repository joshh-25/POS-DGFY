  ...
  const lines = (Array.isArray(cart) ? cart : []).map((line) => {
    ...
    return {
      ...
      item_discount_snapshot: {
        ...
        employee_directory_id: Number(draft.employee_directory_id) || null,
...
export const getItemDiscountDraft = (line) => {
  ...
  return {
    ...
    employee_directory_id: discount.employee_directory_id ? String(discount.employee_directory_id) : '',
